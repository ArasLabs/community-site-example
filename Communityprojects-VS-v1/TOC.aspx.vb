...
#End Region
    ...
    Public Sub LoadProjectBrief(ByVal id As String)
        ...
        AML = "<Item type='CP_CommunityProject' action='get' select='name' id='" & id & "'></Item>"
        Result.loadXML(SendAML("ApplyItem", AML, ConfigDom, LogName, False))
    ...
    Public Sub LoadProjectList(ByVal cat As String)
        ...
        AML = "<Item type='CP_CommunityProject' action='get' select='name,rating,description,downloads' order_by='name'><cp_category>" & cat & "</cp_category></Item>"
        Result.loadXML(SendAML("ApplyItem", AML, ConfigDom, LogName, False))
        Projects = Result.OuterXML
    ...
    Public Sub LoadProjectDetail(ByVal id As String)
        ...
        AML = "<Item type='CP_CommunityProject' action='get' select='name,author(keyed_name),description,downloads,rating,cp_type,cp_level,cp_category,license,versions,dev_status,screenshot(filename),thumbnail(filename)' id='" & id & "'></Item>"
        Result.loadXML(SendAML("ApplyItem", AML, ConfigDom, LogName, False))
    ...
    Public Sub LoadProjectFiles(ByVal id As String)
        ...
        AML = "<Item type='CP_Builds' action='get' select='version,notes'><source_id>" & id & "</source_id><Relationships><Item type='CP_Builds File' action='get' select='related_id(filename,file_size)'></Item></Relationships></Item>"
        Result.loadXML(SendAML("ApplyItem", AML, ConfigDom, LogName, False))
    ...
    Public Sub LoadTOC()
        ...
        AML = "<Item type='CP_CommunityProject' action='get' select='name'><state>Active</state></Item>"
        Result.loadXML(SendAML("ApplyItem", AML, ConfigDom, LogName, False))
        Projects = Result.OuterXML
